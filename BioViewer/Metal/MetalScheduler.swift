...
class MetalScheduler {
    ...
    private var createSphereModelBundle = MTLCompiledFunction()
    ...
    public func createSphereModel(protein: Protein) -> (vertexData: MTLBuffer?, indexData: MTLBuffer?) {
        ...
        metalDispatchQueue.sync {
            ...
            if createSphereModelBundle.requiresCompilation(newFunctionParameters: nil) {
                createSphereModelBundle.compile(functionName: "createSphereModel",
