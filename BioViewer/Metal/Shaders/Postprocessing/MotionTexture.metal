...
kernel void motion_texture(constant ReprojectionData& reprojection_data [[ buffer(0) ]],
    ...
    if (depth == 1.0) {
        ...
        texture_position_normalized.y = texture_position.x / reprojection_data.renderHeight;
        ...
        old_texture_position_normalized.y = old_texture_position.x / reprojection_data.renderHeight;
